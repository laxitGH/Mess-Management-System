...
public class instituteMngController implements Initializable{
    ...
    @FXML
    void addManagementAction(ActionEvent event) throws Exception{
        ...
        ManagementAddedNote.setText("Institute Management Added");
        clearFields();
